DROP TABLE IF EXISTS GENRES, MPA, FRIENDSHIP_STATUS, PUBLIC.DIRECTORS, USERS, FILM_GENRES, FILM_SCORE,
    LIST_OF_FRIENDS, REVIEWS, PUBLIC.REVIEWS_LIKES, PUBLIC.FILM_DIRECTOR, EVENT_TYPE, OPERATION_FOR_FEEDS, FEEDS, FILMS;
