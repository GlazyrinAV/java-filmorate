DROP TABLE IF EXISTS GENRES, RATINGS, FRIENDSHIP_STATUS, PUBLIC.DIRECTORS, FILMS, USERS, FILM_GENRES, FILM_LIKES,
...
(
    ...
    "Friendship_status_name" CHARACTER(20) NOT NULL UNIQUE
);
